...
const filterStringsWithVowels = (arr) => {
  //Still running into issues with this one.
  return arr.filter ( value => {if (value === /[aeiou]/) {return true}});
};
...
const notInFirstArray = (notInArray, arr) => {
    return arr.filter(value => {if(!notInArray.includes(value)){return value;}})
};
...
const getBaseStatGreaterThan = (arr, minStat) => {
   return arr.filter( value => {if(value.baseStat > minStat){return value;}});
};
...
Write a function named getCharactersWithoutChildren that, given the array of characters, below, uses filter to return an array of all
characters without children.
------------------------------------------------------------------------------------------------ */
...
const getCharactersWithoutChildren = (arr) => {
    return arr.filter(value => {if(! value.children){return value;}})
};
