...
const hasChildrenEntries = (arr, character) => {
  arr.forEach( element => {
    if(element === character){
      if (arr.element.children.length > 0){
        return true;
      } else {
        return false;
      }
...
xdescribe('Testing challenge 7', () => {
  test('It should not include any deceased spouses', () => {
    expect(houseSurvivors(characters)).toStrictEqual([ { house: 'Stark', members: 6 }, { house: 'Arryn', members: 2 },
      { house: 'Lannister', members: 4 }, { house: 'Targaryen', members: 4 }, { house: 'Tyrell', members: 3 }, { house: 'Stark', members: 2 },
